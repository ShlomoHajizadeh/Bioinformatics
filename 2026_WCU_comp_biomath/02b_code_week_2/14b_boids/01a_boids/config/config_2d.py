"""
Configuration for 2D Reynolds boids simulation.
"""


class Config2D:
    """Configuration parameters for 2D simulation."""
    
    def __init__(self):
        # Domain
        self.dimension = 2
        self.domain_size = [100.0, 100.0]  # [width, height]
        
        # Species 1: Boids (full rules)
        self.n_species1 = 200  # Large number
        self.species1_label = 0
        
        # Species 2: Avoidance-only agents
        self.n_species2 = 20  # Small number
