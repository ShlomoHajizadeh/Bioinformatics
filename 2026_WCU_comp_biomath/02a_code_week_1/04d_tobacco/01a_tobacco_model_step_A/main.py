"""
Main entry point for Version A of the tobacco ecosystem model.
"""
...
from output.plots import plot_time_series, plot_final_health, plot_final_caterpillars
...
def main():
    ...
    plot_final_caterpillars(sim.state["caterpillars"], params.OUTPUT_DIR)
