"""
Grid initialization utilities for Version D.
"""
...
def initialize_signal(height, width):
    return np.zeros((height, width), dtype=float)


def initialize_priming(height, width):
    return np.zeros((height, width), dtype=float)


def initialize_predator_attractant(height, width):
    return np.zeros((height, width), dtype=float)


def initialize_growth_inhibitor(height, width):
    return np.zeros((height, width), dtype=float)
