...
def run_population_tournament(
    ...
    for i in range(n):
        ...
        for j in range(j_start, n):
            ...
            scoreboard[strategy_a.name]["noise_flips"] += match_result["noise_flips_a"] * weight

            scoreboard[strategy_b.name]["total_score"] += weighted_score_b
            scoreboard[strategy_b.name]["effective_matches"] += weight
            scoreboard[strategy_b.name]["noise_flips"] += match_result["noise_flips_b"] * weight
            ...
            results.append({
                ...
                "noise_flips_a": match_result["noise_flips_a"],
                "noise_flips_b": match_result["noise_flips_b"],
            })
